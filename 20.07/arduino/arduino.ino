...
int nbJoueurs4 = 4;
int oldCible = 1;
int resteEnCours = 3; // <<<--- Nb de tir ( Classic )
int resteEnCoursLJ = 1000000; // <<<--- Nb de tir ( LJ ) + ( illimité )
int resteEnCoursMS = 1000000; // <<<--- Nb de tir ( MS ) + ( illimité )
int resteEnCoursCPT = 1000000; // <<<--- Nb de tir ( CPT ) + ( illimité )
int tourEnCours = 1;
int tourEnCoursLJ = 1;
int tourEnCoursMS = 1;
...
void loop() {
  ...
  // 5. Démarrage effectif de la partie après validation utilisateur
    ...
    else if (groupeSelectionne == "LJ1")      InitGameLJ();
    else if (groupeSelectionne == "LJ2")      InitGameLJ();
    else if (groupeSelectionne == "LJ3")      InitGameLJ();
    else if (groupeSelectionne == "LJ4")      InitGameLJ();
    else if (groupeSelectionne == "MS1")      InitGameMS();
    else if (groupeSelectionne == "MS2")      InitGameMS();
    else if (groupeSelectionne == "MS3")      InitGameMS();
    else if (groupeSelectionne == "MS4")      InitGameMS();
    else if (groupeSelectionne == "CPT1")     InitGameCPT();
  ...
  // 6. Jeu en cours : traitement selon le mode sélectionné
    ...
    else if (groupeSelectionne == "LJ1")      trtPartieEnCoursLJ();
    else if (groupeSelectionne == "LJ2")      trtPartieEnCoursLJ();
    else if (groupeSelectionne == "LJ3")      trtPartieEnCoursLJ();
    else if (groupeSelectionne == "LJ4")      trtPartieEnCoursLJ();
    else if (groupeSelectionne == "MS1")      trtPartieEnCoursMS();
    else if (groupeSelectionne == "MS2")      trtPartieEnCoursMS();
    else if (groupeSelectionne == "MS3")      trtPartieEnCoursMS();
    else if (groupeSelectionne == "MS4")      trtPartieEnCoursMS();
    else if (groupeSelectionne == "CPT1")     trtPartieEnCoursCPT();
  }
  // 7. Fin de partie
  else if (partieFinie) {
    trtPartieFinie();
